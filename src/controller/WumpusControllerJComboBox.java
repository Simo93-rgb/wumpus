...
public class WumpusControllerJComboBox implements ActionListener {
	...
	public void actionPerformed(ActionEvent evt) {
		if(evt.getActionCommand().equals("Esegui")) {
			...
			// viene eseguito il comnado impostato attraverso le JComboBox della GUI in cui e' stato premuto
			// il bottone "Esegui"
			
			// Splitto la String contenente l'azione da compiere nell'array di String "comandi"
		...
		if(evt.getActionCommand().equals("Regole")) {
			...
			try {
				myReader = new FileReader(new File(file));
				BufferedReader bf=new BufferedReader(myReader);
				myScanner = new Scanner(bf);
				LinkedList<String> regole = new LinkedList<String>();
