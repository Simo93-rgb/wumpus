...
class TestElemento {
	...
	@Test
	void testGetInGioco() {
		Assertions.assertEquals(true, this.elementoPerTest.getInGioco());
	}
	...
	void testEquals(String latoScacchiera, String riga, String colonna, String atteso) {
		...
		Assertions.assertTrue(Boolean.parseBoolean(atteso) == this.elementoPerTest.equals(attuale));
	}
	...
	void testEqualsConSottoclasse(String latoScacchiera, String riga, String colonna, String atteso) {
		...
		Assertions.assertTrue(Boolean.parseBoolean(atteso) == this.elementoPerTest.equals(altro));
	}
	...
	void testEqualsConElementoEliminato() {
		...
		Assertions.assertFalse(this.elementoPerTest.equals(altro));
	}
	
	@Test
	void testEqualsConNull(){
		Assertions.assertFalse(this.elementoPerTest.equals(null));
	}
	
	@Test
	void testEqualsConOggettoGenerico(){
		Assertions.assertFalse(this.elementoPerTest.equals(new Object()));
	}
}