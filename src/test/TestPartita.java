...
class TestPartita {
    ...
    void testTurnoDiGiocoAgenteTrueWumpusTrue() throws IllegalArgumentException, IOException {
        /*
         * Premessa: per come e' costruita la mappa il cucciolo di Wumpus puo' andare solamente nella casella
    ...
    void testTurnoDiGiocoSpostamentoSUD() throws IllegalArgumentException, IOException {
         ...
         * Premessa: per come e' costruita la mappa il cucciolo di Wumpus puo' andare solamente nella casella
         *           (4,1) ed essendo garantito lo spostamento siamo sicuri che andra'
         *           nella casella opportuna. Quindi e' lecito l'inserimento manuale della stringa per il cucciolo di Wumpus.
         */
    ...
    private static class Corribile implements Runnable {
