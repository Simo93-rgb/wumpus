...
class TestAgente {
    ...
    private static class Agente extends model.elementi.Agente {

        private Agente(int latoMappa, int riga, int colonna, String nome, boolean inGioco, int numFrecce, int punteggio) throws IllegalArgumentException, IndexOutOfBoundsException {
