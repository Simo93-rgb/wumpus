...
public abstract class ElementoMobile extends ElementoEliminabile {
	 ...
	 * strettamente maggiore di 0 e che le coordinate siano valide rispetto alla dimensione del lato
	 ...
	 * Il metodo è concreto, ma dato che il movimento di un elemento mobile potrà variare a seconda dei
	 * vari giochi (ogni gioco può avere regole di spostamento differenti) le sottoclassi che estendono
