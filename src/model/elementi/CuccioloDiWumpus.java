...
public class CuccioloDiWumpus extends PersonaggioMondoDelWumpus {
     ...
     * @param colonna   Indice della colonna in cui si vuole collocare il CuccioloDiWumpus.
     * @param nome      Nome da attribuire al CuccioloDiWumpus.
     * @param inGioco   Indica se il CuccioloDiWumpus e' in gioco.
     * @throws IllegalArgumentException  Se la dimensione del lato della mappa non e' strettamente maggiore di ZERO.
     * @throws IndexOutOfBoundsException Se le coordinate eccedono i limiti della mappa.
     */
    ...
    public String sposta(Mappa mappaDiGioco) {
		...
		*/
		...
		/*
		 ...
		 di elementi ripetuti); in questo modo se l'HashSet raggiunge la dimensione QUATTRO
		 si ha la conferma di aver gia' tentato tutte le QUATTRO direzioni di spostamento
		 possibili.
		*/
        HashSet<Direzioni> direzioniGiaTentate = new HashSet<>();
		...
		*/
        do {
			...
			*/
            ...
            } while (direzioniGiaTentate.contains(direzione));
			...
			*/
			...
			/*
			 ...
			 semplicemente il costruttore di PersonaggioMondoDelWumpus con firma
     ...
     *
     * @param agente Agente con cui e' avvenuta la collisione.
    ...
    /**
     * Metodo che rimuove dal gioco il CuccioloDiWumpus perche' ucciso da parte dell'Agente.
     *
