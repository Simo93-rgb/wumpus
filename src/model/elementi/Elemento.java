...
public abstract class Elemento {
     ...
     * che restituisce un intero compreso tra ZERO e (latoScacchiera - 1).
     ...
     * dimensione del lato sia un valore strettamente maggiore di ZERO e che le coordinate siano valide rispetto
    ...
    /**
     * Metodo che restituisce un booleano che indica se l'Elemento � ancora in gioco o no.
     *
    ...
    public boolean equals(Object altro) {
        if (!(altro instanceof Elemento altroElemento)) {
            return false;
        }
